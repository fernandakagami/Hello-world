=begin 01-Escreva um programa para receber um nome pelo teclado, converter para maiúsculas e imprimir as 2 primeiras letras do nome.
=end
...
=begin 03-Escreva um programa que traduza uma frase de português para o idioma PigLatin. Para realizar a tradução, basta remover as vogais das palavras em português. Por exemplo, “Olá Mundo” ficaria l mnd em Pig Latin.
=end
